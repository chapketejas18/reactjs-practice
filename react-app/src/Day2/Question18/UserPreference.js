    ...
    <div className="preference">
      ...
      >
        {currentPreference && currentPreference.language === "english" ? (
          <>
            272/2 by Kolkata Knight Riders is the second-highest total in IPL
            and the seventh-highest in all T20 cricket. The only higher total in
            IPL was exactly a week ago by Sunrisers Hyderabad against Mumbai
            Indians in Hyderabad when they smashed 277/3.
          </>
        ) : (
          <>
            272/2 de Kolkata Knight Riders es el segundo total más alto en IPL y
            el séptimo más alto en todo el cricket T20. El único total más alto
            en IPL fue hace exactamente una semana entre los Sunrisers Hyderabad
            contra los indios de Mumbai en Hyderabad cuando aplastaron 277/3.
          </>
        )}
      </div>
    </div>
